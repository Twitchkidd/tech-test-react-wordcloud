...
// ! I think async needs to be called lower down
async function init() {
  ...
  // ! This is where the problem is, you need to figure out the flow, it's not like reading the file comes for free
  const blogPostsReducer = async (accumulator, currentBlogPostFilename, i) => {
